...
int main() {
using namespace hello_attributes;
...
#pragma endregion
    ...
    glEnableVertexAttribArray(0);
                                                                                                                       // notice that the pointer has moved.
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*) (3 * sizeof(float)));
    glEnableVertexAttribArray(1);


    auto vertex_shader_source = read_shader_file("vertex_shader_prog_colour.glsl");
    ...
    auto fragment_source = read_shader_file("fragment_prog_colour.frag");
